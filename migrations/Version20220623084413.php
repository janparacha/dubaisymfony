 ...
 */
final class Version20220623084413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, quantity_ml INT DEFAULT NULL, reference INT DEFAULT NULL, price_ht INT NOT NULL, tva INT NOT NULL, stock INT DEFAULT NULL, picture VARCHAR(150) DEFAULT NULL, INDEX IDX_B3BA5A5A12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
